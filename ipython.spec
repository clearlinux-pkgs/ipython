...
Source0  : https://files.pythonhosted.org/packages/88/91/666a7fa24bab1396537fcd8e2b287a2d773605ad16020af81036c8c1438c/ipython-7.16.1.tar.gz
...
%prep
%setup -q -n ipython-7.16.1
cd %{_builddir}/ipython-7.16.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593466627
...
cp %{_builddir}/ipython-7.16.1/COPYING.rst %{buildroot}/usr/share/package-licenses/ipython/f8e8135e4c13eb9436ff08f23dbd3362be77a543
cp %{_builddir}/ipython-7.16.1/LICENSE %{buildroot}/usr/share/package-licenses/ipython/68f5a6f2199e7779b637c326af87d70ef6ee6222
cp %{_builddir}/ipython-7.16.1/docs/source/about/license_and_copyright.rst %{buildroot}/usr/share/package-licenses/ipython/7ababbc82643a97634faa381d823f624683844c0
