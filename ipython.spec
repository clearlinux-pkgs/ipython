...
Source0  : https://files.pythonhosted.org/packages/16/af/bc2b3bb4882642c5d68525b196b9eefcfb944fb99bf2bf5627743b7ff756/ipython-7.10.2.tar.gz
...
%prep
%setup -q -n ipython-7.10.2
cd %{_builddir}/ipython-7.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576512249
...
cp %{_builddir}/ipython-7.10.2/COPYING.rst %{buildroot}/usr/share/package-licenses/ipython/f8e8135e4c13eb9436ff08f23dbd3362be77a543
cp %{_builddir}/ipython-7.10.2/LICENSE %{buildroot}/usr/share/package-licenses/ipython/68f5a6f2199e7779b637c326af87d70ef6ee6222
cp %{_builddir}/ipython-7.10.2/docs/source/about/license_and_copyright.rst %{buildroot}/usr/share/package-licenses/ipython/7ababbc82643a97634faa381d823f624683844c0
