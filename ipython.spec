...
Source0  : https://pypi.python.org/packages/e7/75/7c981d2d7f25754ef64f955b595c2d80e2fec1aa47e52bd55ab35dbc8ccf/ipython-5.2.1.tar.gz
...
%prep
%setup -q -n ipython-5.2.1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1486095452
