...
Source0  : https://files.pythonhosted.org/packages/ae/b9/3c5dcecdc658783fee3dd760a9e1957312a2d9d75b8d8fc6988f629ab14a/ipython-7.20.0.tar.gz
...
%prep
%setup -q -n ipython-7.20.0
cd %{_builddir}/ipython-7.20.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612226526
...
cp %{_builddir}/ipython-7.20.0/COPYING.rst %{buildroot}/usr/share/package-licenses/ipython/f8e8135e4c13eb9436ff08f23dbd3362be77a543
cp %{_builddir}/ipython-7.20.0/LICENSE %{buildroot}/usr/share/package-licenses/ipython/68f5a6f2199e7779b637c326af87d70ef6ee6222
cp %{_builddir}/ipython-7.20.0/docs/source/about/license_and_copyright.rst %{buildroot}/usr/share/package-licenses/ipython/7ababbc82643a97634faa381d823f624683844c0
